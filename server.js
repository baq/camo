...
(function() {
  var Crypto, Fs, Http, Https, Path, QueryString, Url, accepted_audio_mime_types, access_log, camo_hostname, content_length_limit, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, hexdec, keep_alive, logging_enabled, max_redirects, port, process_url, server, shared_key, socket_timeout, started_at, total_connections, version,
  ...
  accepted_audio_mime_types = JSON.parse(Fs.readFileSync(Path.resolve(__dirname, "mime-types.json"), {
    encoding: 'utf8'
  }));
        ...
        if (content_length > content_length_limit) {
          ...
          switch (srcResp.statusCode) {
            ...
            default:
              ...
              if (indexOf.call(accepted_audio_mime_types, contentTypePrefix) < 0) {
                srcResp.destroy();
  ...
  server = Http.createServer(function(req, resp) {
    ...
    if (req.method !== 'GET' || req.url === '/') {
      ...
      transferredHeaders = {
        ...
        'Accept': (ref = req.headers.accept) != null ? ref : 'audio/*',
